...
namespace FirstCLRProject {
	...
	//Ïåðåìåííûå äëÿ îáðàáîòêè âû÷èñëåíèé
...
#pragma region Windows Form Designer generated code
	...
	private: System::Void button_result_Click(System::Object^  sender, System::EventArgs^  e) {
		// ôèêñ íàæàòèÿ íà ðàâíî ïðè 1-ì ââåäåííîì ÷èñëå
		...
		case '/':
			if (second == 0) {
				...
				MessageBox::Show(this, "Äåëåíèå íà 0 çàïðåùåíî", "Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
			else {
